    ...
    <>
      <div className="main-div-body">
        <BrowserRouter>
          ...
          <Route path="/EditMyProfile" element={<DrEditProfile></DrEditProfile>}></Route>
          <Route path="/MyProfile" element={<DRProfile></DRProfile>}></Route>
          <Route path="/MyPatientRequestList" element={<PatientsRequestList></PatientsRequestList>}></Route>
          <Route path="/MyPatientnList" element={<PatientsList></PatientsList>}></Route>
