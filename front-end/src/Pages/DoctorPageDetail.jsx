      ...
      {psyInfo.slice(0, 2).map((item) => {
        ...
        <img
              ...
              <div className="detail-docor-buttom-page-left">
               ...
               <div className="detail-doctor-req" style={{
                backgroundColor: "white"
                  ...
                  <button className="detail-doctor-req-button">ثبت درخواست برای { item.name}</button>
                </div>
                ...
                backgroundColor: "white"
                 ...
                 <h5 className="loc-h5-text text-rate-top">میزان رضایت از پزشک</h5>
                  ...
                  <div className="rate-div-deatail-doc">
                    <i className="mdi mdi-star f-19" style={{marginLeft:"2px"}}></i>
            ...
            {item.rating}
                  ...
                  <button className="detail-doctor-req-button">  رای دادن به  { item.name}</button>
        {/* </div> */}
              </div>
              </div>     
